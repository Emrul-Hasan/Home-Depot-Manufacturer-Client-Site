...
const Blogs = () => {
    return (
        <section className='py-14 bg-slate-500'>
            <div className='product-container'>
                <div className="card lg:max-w-lg bg-base-100 shadow-xl">
                    <article className="card-body">
                        ...
                        <p className='mt-5'>We use React JS library to make easy our web development process. Our coding pattern can improve the performance of our React application. The React performance optimization techniques are given below:
                            <ul className='list-inside list-decimal mt-2 font-bold'>
                ...
                <div className="card lg:max-w-lg bg-base-100 shadow-xl">
                    <article className="card-body">
                        <h1 className=' font-bold text-3xl'>Why you do not set the state directly in React.</h1>
                ...
                <div className="card lg:max-w-lg bg-base-100 shadow-xl">
                    <article className="card-body">
                        <h1 className=' font-bold text-2xl'>You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h1>
