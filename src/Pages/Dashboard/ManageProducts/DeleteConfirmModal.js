...
const DeleteConfirmModal = ({ deletingTool, refetch, setDeletingTool }) => {
    ...
    const handleDelete = () => {
        fetch(`https://thawing-wildwood-78264.herokuapp.com/tool/${_id}`, {
            method: 'DELETE',
            headers: {
        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    <h3 className="font-bold text-lg">Are You sure to <span className='text-red-600'>delete</span> <span className='text-primary font-bold'>{name}</span>?</h3>
