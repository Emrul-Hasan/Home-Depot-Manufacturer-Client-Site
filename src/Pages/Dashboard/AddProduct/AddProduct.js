            ...
            <div className='add-review-container'>
                <div className='add-product-form'>
                    ...
                    <form onSubmit={handleAddProduct}>
                        ...
                        <input onChange={handleMinimumQuantity} type="number" name="minimum" id="quantity-input-field" placeholder='Minimum quantity' />

                        <label>
                            {minimum < 1 && <span className="text-xs label-text text-red-600">Minimum Quantity must be 1 or longer</span>}
                            {minimum > available && <span className="text-xs label-text text-red-600">Minimum Quantity must be less than available quantity</span>}
                        </label>
